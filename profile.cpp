...
void Profiler::Profile(void) {
  ...
  for (const auto &sample : samples) {
    ...
    const auto [aveTime, minTime, maxTime] = storeProfile(sample.name, percentTime);        
